...
public class InGameFrame2{

    public static int buttonSize = (Drawer.FRAME_HEIGHT/2)/8;
    ...
    /**
     *  This constructer automatically creates the window for the graph and generates a custom graph based on the inputs. It also starts the timer.
    ...
    public InGameFrame2(int n, int m) {
     ...
     *  @param input is the path of the file as string
     */
    public InGameFrame2(String input) {
