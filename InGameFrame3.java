...
public class InGameFrame3{
    ...
    public static ArrayList<NodeButton> NodeList = new ArrayList<NodeButton>();
     ...
     */
    public InGameFrame3(int n, int m) {
        this.n = n;
        this.m = m;
        randomShuffle();
        frame = new JFrame();
     ...
     */
    public InGameFrame3(String inputfile) {
        ...
        frame.getContentPane().setLayout(null);
        d = new Drawer();
        graph = d.generateGM3(inputfile);
        nodes = d.g.nodes;
        n = d.g.getAmountVertices();
        m = d.g.getAmountEdge();
        randomShuffle();
    ...
    public void randomShuffle()
    {
        ...
        while(!notUsed.isEmpty())
        {
            ...
            int rng = (int) (Math.random() * notUsed.size());
            temp[i] = notUsed.get(rng);
            notUsed.remove(rng);
            i++;

        }
        System.out.println("Shuf"+ Arrays.toString(temp));
